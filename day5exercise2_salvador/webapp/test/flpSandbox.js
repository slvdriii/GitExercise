		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Navigation",
									"targetURL": "#zbtpday5exercise2salvador-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise2salvador-display": {
								"semanticObject": "zbtpday5exercise2salvador",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise2salvador",
									"url": sap.ui.require.toUrl("zbtp/day5exercise2salvador")
								}
							}
						}
					}
