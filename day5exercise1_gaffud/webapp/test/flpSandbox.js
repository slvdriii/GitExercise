		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpday5exercise1gaffud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise1gaffud-display": {
								"semanticObject": "zbtpday5exercise1gaffud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise1gaffud",
									"url": sap.ui.require.toUrl("zbtp/day5exercise1gaffud")
								}
							}
						}
					}
